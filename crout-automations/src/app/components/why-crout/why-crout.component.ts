...
export class WhyCroutComponent {
  ...
  constructor(private sanitizer: DomSanitizer) {
    const raw: { title: string; body: string; icon: string }[] = [
      {
        title: 'Local Pricing in Rands',
        body: 'No dollar invoices or currency surprises. Everything is priced in ZAR and built around SA business budgets.',
      ...
      },
      {
        ...
        body: 'All workflows, credentials, and documentation belong to you. No lock-in. No black boxes.',
      ...
      {
        title: '24hr Support Response',
        body: 'Something breaks at 11pm? We respond within 24 hours — and most issues are fixed the same day.',
        icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>'
      },
      {
        title: 'No Bloated Retainers',
        body: 'Pay once to build. Monthly support is optional. Start small, scale when ready.',
        icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 12 20 22 4 22 4 12"/><rect x="2" y="7" width="20" height="5"/><line x1="12" y1="22" x2="12" y2="7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/></svg>'
      },
      {
        title: 'Built by a Developer',
        body: 'Not a no-code reseller. Custom logic, API integrations, and edge cases handled properly from day one.',
    ...
    this.reasons = raw.map(r => ({
      ...r,
      icon: this.sanitizer.bypassSecurityTrustHtml(r.icon)
    }));
  }
}
