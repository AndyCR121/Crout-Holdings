  ...
  subServices = [
    {
      ...
      features: [
        'Auto-push quotes to Xero',
        'Client record sync',
        'Live invoice status tracking',
        'Real-time Xero balance checks',
    ...
    },
    {
      ...
      features: [
        'Fully bespoke quote builder',
        'Custom approval workflows',
        'Multi-tier pricing rules',
        'Client-facing quote portal',
        'Digital signature support',
        'Any format output (PDF, email, WhatsApp)'
      ],
      badge: null
    },
    {
      ...
      features: [
        'Itemised line-item summaries',
        'Management sign-off triggers',
    ...
    },
    {
      ...
      features: [
        ...
        'Material & labour formulas',
        'Margin & markup rules',
        'Multi-variable rate cards',
